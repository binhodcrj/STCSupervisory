...
#Region "PLC Related Properties"
    ...
    'Private m_PLCAddressValueItems As New MfgControl.AdvancedHMI.Drivers.PLCAddressItemCollection
    ...
    Public ReadOnly Property PLCAddressValueItems() As System.Collections.ObjectModel.ObservableCollection(Of MfgControl.AdvancedHMI.Drivers.PLCAddressItem)
        'Public ReadOnly Property PLCAddressValueItems() As MfgControl.AdvancedHMI.Drivers.PLCAddressItemCollection
        Get
