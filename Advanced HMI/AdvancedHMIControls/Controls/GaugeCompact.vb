...
#Region "Properties"
    ...
    Public Overrides Property Text() As String
        ...
        Set(ByVal value As String)
            '* V3.99y beta 24 - added because NumericFormat is also used for gage numbers
            Dim result As Double
            If (Not DesignMode) AndAlso Double.TryParse(value, result) Then
                If (Not String.IsNullOrEmpty(NumericFormat)) Then
                    Try
                        MyBase.Text = (result).ToString(NumericFormat)
