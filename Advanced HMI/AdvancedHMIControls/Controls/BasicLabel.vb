...
#Region "Constructor"
    ...
    Protected Overrides Sub Dispose(ByVal disposing As Boolean)
        Try
            If disposing Then
                If SubScriptions IsNot Nothing Then SubScriptions.Dispose()
                If m_KeypadFont IsNot Nothing Then m_KeypadFont.Dispose()
            End If
        Finally
    ...
    Private Sub UpdateText()
        ...
        If Not String.IsNullOrEmpty(ResultText) Then
            ...
            If (String.Compare(m_Value, "True", True) = 0) Then
                ...
                If m_BooleanDisplay = BooleanDisplayOption.EnabledDisabled Then ResultText = "Enabled"
                If m_BooleanDisplay = BooleanDisplayOption.AutoManual Then ResultText = "Auto"
            ElseIf (String.Compare(m_Value, "False", True) = 0) Then
                ...
                If m_BooleanDisplay = BooleanDisplayOption.EnabledDisabled Then ResultText = "Disabled"
