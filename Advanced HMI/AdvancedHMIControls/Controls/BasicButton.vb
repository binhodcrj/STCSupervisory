...
#Region "Basic Properties"
    Private m_BackColor As Color = Color.LightGray
    ...
    '***************************************************************
    Private m_Highlightcolor As Drawing.Color = Drawing.Color.Green
    ...
    Public Property ForeColorAlternate As Color
        Get
...
#Region "Events"
    ...
    Private Sub ReleaseValue()
        ...
        Catch ex As MfgControl.AdvancedHMI.Drivers.Common.PLCDriverException
            ...
            End If
        Catch ex As Exception
            '* V3.99y - added generic catch
            MsgBox("Failed to release button bit. " & ex.Message)
        End Try
    End Sub
