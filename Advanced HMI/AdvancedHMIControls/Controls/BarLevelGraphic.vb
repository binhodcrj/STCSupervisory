...
Public Class BarLevelGraphic
    Inherits MfgControl.AdvancedHMI.Controls.BarLevelGraphic
    ...
    Public Overrides Property Text() As String
        ...
        Set(ByVal value As String)
            ...
            Else
                Dim v As Double
                '* v3.99y
                If Double.TryParse(value, Globalization.NumberStyles.Number, System.Globalization.NumberFormatInfo.CurrentInfo, v) Then
